...
<body>
	...
	<div class="container" style= "margin-top: 80px">
		<div>
			<input type="text" id="memberId" placeholder="아이디" class="form-control" onfocusout="fn_dupCheck(this)" 
			value="" style= "width: 200px; margin-bottom:10px"/>
...
var fn_addRow = function () {
	...
	var addTr = '<tr>';
    addTr += '<td></td>';
    addTr += '<td><input id="sMemberId" onfocusout="fn_dupCheck(this)" /></td>';
...
var Change = function (tag , target) {
	...
	var d = '';
	switch (tag.value) {
		case '한국': d = city_a; break;
		case '미국': d = city_b; break;
		case '중국': d = city_c; break;
		case '일본': d = city_d; break;
		default:  d = city_z;
    }
